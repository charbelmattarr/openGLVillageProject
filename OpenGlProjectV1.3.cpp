...
void tree(int dist)
{
	...
	glScalef(.5, .5, .5);
	glBegin(GL_POLYGON);
	glVertex2i(72 + dist, 300);
	glVertex2i(78 + dist, 300);
	glVertex2i(78 + dist, 405);
	glVertex2i(72 + dist, 405);
	glEnd();

	glColor3f(.1, 0.5, 0.1);
	glBegin(GL_POLYGON);
	glVertex2i(75 + dist, 450);
	glVertex2i(100 + dist, 390);
	glVertex2i(50 + dist, 390);

	glEnd();
	glBegin(GL_POLYGON);
	glVertex2i(75 + dist, 420);
	glVertex2i(100 + dist, 360);
	glVertex2i(50 + dist, 360);

	glEnd();
	glBegin(GL_POLYGON);
	glVertex2i(75 + dist, 400);
	glVertex2i(100 + dist, 340);
	glVertex2i(50 + dist, 340);
...
void drawstring(float x, float y, float z, const char* string)
{
	...
	for (ct = string; *ct != '\0'; ct++)
	{
		...
		glutBitmapCharacter(GLUT_BITMAP_8_BY_13, *ct);
	}
}
void many_trees() {
	for (int i = 0; i < 22; i++) {
...
void draw_object()
{
	...
	for (l = 0; l <= 20; l++)
	{
		...
		drawstring(155 + m, 625, 0.0, "Hello Doctor");
	...
	for (l = 0; l <= 35; l++)
	{
		...
		drawstring(400 + m, 615, 0.0, "Ibtisam");
	...
	glVertex2i(0, 340 + xz);
	glVertex2i(50, 400 + xz);
	glVertex2i(100, 340 + xz);

	glVertex2i(80, 350 + xz);
	glVertex2i(200, 450 + xz);
	glVertex2i(300, 350 + xz);

	glVertex2i(280, 340 + xz);
	glVertex2i(360, 430 + xz);
	glVertex2i(450, 340 + xz);

	glVertex2i(480, 340 + xz);
	glVertex2i(560, 430 + xz);
	glVertex2i(640, 340 + xz);
	glEnd();
	// trees
	many_trees();
	/**tree1**/
	...
	{
		glColor3f(0.0, 0.5, 0.0);
		draw_circle(540, 400, l);
		draw_circle(580, 400, l);
	}
	for (l = 0; l <= 25; l++)
	{
		glColor3f(0.0, 0.5, 0.0);
		draw_circle(550, 440, l);
		draw_circle(570, 440, l);
	}
	for (l = 0; l <= 20; l++)
	{
		glColor3f(0.0, 0.5, 0.0);
		draw_circle(560, 465, l);
	}
	...
	glBegin(GL_POLYGON);
	glVertex2i(72 + xx, 300);
	glVertex2i(78 + xx, 300);
	glVertex2i(78 + xx, 405);
	glVertex2i(72 + xx, 405);
	glEnd();

	glColor3f(.1, 0.5, 0.1);
	glBegin(GL_POLYGON);
	glVertex2i(75 + xx, 450);
	glVertex2i(100 + xx, 390);
	glVertex2i(50 + xx, 390);

	glEnd();
	glBegin(GL_POLYGON);
	glVertex2i(75 + xx, 420);
	glVertex2i(100 + xx, 360);
	glVertex2i(50 + xx, 360);

	glEnd();
	glBegin(GL_POLYGON);
	glVertex2i(75 + xx, 400);
	glVertex2i(100 + xx, 340);
	glVertex2i(50 + xx, 340);
...
int main(int argc, char* argv[])
{
	...
	printf(" |                                                           |\n");
	printf(" |-----------------------------------------------------------|\n");
	printf(" |====== Created By Clarita HAWAT & Charbel MATTAR ==========|\n");
	printf(" |===========================================================|\n");
	glutInit(&argc, argv);
	glutInitDisplayMode(GLUT_SINGLE | GLUT_RGB);
	glutInitWindowSize(1100.0, 700.0);
	glutInitWindowPosition(250, 0);
	glutCreateWindow("Clarita HAWAT & Charbel MATTAR");
	myinit();
